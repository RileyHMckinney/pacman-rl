...
def greedy_action(agent, state):
    """Always pick argmax(Q(s)); ignores epsilon, exploration, etc."""
    with torch.no_grad():
...
def main():
    ...
    run_viewer(env, pac_agent, ghost_agent, "Phase 1 Viewer")
